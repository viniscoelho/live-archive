...
int main(){
    ...
    for ( cin >> str; str != "."; cin >> str ){
		...
		for ( cin >> str; str != "-" && str != "."; cin >> str ){
			cin >> str2;
			if ( type[str] == 3 && type[str2] == 2 ) p1.first++;
			else if ( type[str] == 2 && type[str2] == 3 ) p2.first++;
			else if ( type[str] == 3 && type[str2] == 1 ) p2.first++;
			else if ( type[str] == 1 && type[str2] == 3 ) p1.first++;
			else if ( type[str] == 2 && type[str2] == 1 ) p1.first++;
			else if ( type[str] == 1 && type[str2] == 2 ) p2.first++;
		}
		cout << p1.second << ": ";
		if ( p1.first == 0 || p1.first > 1 ) cout << p1.first << " points\n";
		else cout << p1.first << " point\n";
		cout << p2.second << ": ";
		if ( p2.first == 0 || p2.first > 1 ) cout << p2.first << " points\n";
